...
| Weight (kg) |     | Initial Volume (${cm^3}$) | Final Volume (${cm^3}$) | Difference in volume (${cm^3}$) | ${\LARGE \frac{1}{V_0} - \frac{1}{V_{gas}}}$ |
| ----------- | --- | ------------------------- | ----------------------- | ------------------------------- | -------------------------------------------- |
| 0           |     | 5.0                       | 5.0                     | 0.0                             | 0.000                                        |
| 400         |     | 5.0                       | 5.9                     | 0.9                             | 0.031                                        |
| 700         |     | 5.0                       | 6.9                     | 1.9                             | 0.055                                        |
| 1000        |     | 5.0                       | 9.0                     | 3.0                             | 0.089                                        |
