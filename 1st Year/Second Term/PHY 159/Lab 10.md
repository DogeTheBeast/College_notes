...
5. After recording one reading, remove the stopper and return the end of the syringe to original position (optional, use a lubricant inside the syringe to decrease the friction inside it.
