...
| 0.2         | 12047                          | ${5.0 \times 10^{-6}}$   | ${5.2 \times 10^{-6}}$  | ${2.0 \times 10^{-7}}$          |                                              |
| 0.4         | 24094                          | ${5.0 \times 10^{-6}}$   | ${5.9 \times 10^{-6}}$  | ${9.0 \times 10^{-7}}$          | 30508                                        |
| 0.5         | 30117                          | ${5.0 \times 10^{-6}}$   | ${6.4 \times 10^{-6}}$  | ${1.4 \times 10^{-6}}$          |                                              |
| 0.7         | 42165                          | ${5.0 \times 10^{-6}}$   | ${6.9 \times 10^{-6}}$  | ${1.9 \times 10^{-6}}$          | 55072                                        |
| 0.9         | 54212                          | ${5.0 \times 10^{-6}}$   | ${9.2 \times 10^{-6}}$  | ${4.2 \times 10^{-6}}$          |                                              |
| 1.0         | 60235                          | ${5.0 \times 10^{-6}}$   | ${9.8 \times 10^{-6}}$  | ${4.8 \times 10^{-6}}$          | 88889                                        |
