...
The value of molar density and atmospheric pressure that we obtained from the revised version resulted in a more accurate result as seen from the values. Even the 
