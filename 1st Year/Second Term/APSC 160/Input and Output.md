...
fprintf takes a file variable (the object which stores the output file) and prints variables to the file in a specific format specified by the format specifier. It is very similar to fscanf.
